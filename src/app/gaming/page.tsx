export default function Gaming(){
    return(
        <div className="bg-gradient-to-t from-gray-400 to-teal-800">
            <h1 className="bg-teal-950 hover:text-red-950">Gaming Experience</h1>
            <p>I have played a lot of games and my favourite game is DriveClub.
                 DriveClub is on ps-4. this is my favourite game because of it's clear graphics and gaming experience.
                 ...
                 <p>My seond favourite game is need for speed no limits.
                    ...
                    i love this game and it's contents.
